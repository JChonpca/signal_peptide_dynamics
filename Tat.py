...
def tat(y, t, miumax, ks, xvmax, kd, kt, xtmax, kxd, yxvs, kpn , kds, ypxv, kpng, kp, 
        k1, kd1, k2, kd2, alpha, kd3, beta, kd4, gama, kd5, d1, d2, d3, d4):
...
#         k1, kd1, k2, kd2, alpha, kd3, beta, kd4, gama, kd5):
    ...
    dpc = k2*mrna - kd2*pc - beta*pc
    
    dpl = beta*pc - kd4*pl - alpha*pl  - kxd*xd/(xv+xd)*pl # 胞质
    
    
    dpp = alpha*pl - kd3*pp - gama*pp - miumax*s/(ks+s)*(1-xv/xvmax)*xv/(xv+xd)*pp - kxd*xd/(xv+xd)*pp  #周质
    
    
    
    
    dpm = gama*pp*xv*d1 + miumax*s/(ks+s)*(1-xv/xvmax)*xv*pp*d2 + kxd*xd*pl*d3 + kxd*xd*pp*d4
...
def goal(x):
    ...
    miumax, ks, xvmax, kd, kt, xtmax, kxd, yxvs, kpn , kds, ypxv, kpng, kp, k1, kd1, k2, kd2, alpha, kd3, beta, kd4, gama, kd5, d1, d2, d3, d4 = x
    ...
    res = odeint(tat, init, simulate_t, args=(miumax, ks, xvmax, kd, kt, xtmax, kxd, yxvs, kpn , kds, ypxv, kpng, kp, k1, kd1, k2, kd2, alpha, kd3, beta, kd4, gama, kd5, d1, d2, d3, d4))
    ...
    loss += ((res[location][:,7] + res[location][:,8]  - data_p[log_ph_start:log_ph,test_index])**2).mean()
    
    loss += ((res[location[0:8]][:,9] - data_pm[log_ph_start:8,test_index])**2).mean()
...
ga = GA(func=goal, n_dim=27, size_pop=200, max_iter=200, prob_mut=0.1, lb=lb_array, ub=ub_array, precision=1e-100)
...
bounds = [(0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 4), (0, 1), (0, 1), (0, 1), (0, 1)]
